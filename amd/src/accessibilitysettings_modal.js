...
export default class AccessibilityModal extends Modal {
    static TYPE = "theme_luuniensuki/themesettings_modal";
    static TEMPLATE = "theme_luuniensuki/luuniensuki/accessibilitysettings_modal";

    constructor(root) {
        super(root);

        let request = Ajax.call([{
            methodname: 'theme_luuniensuki_getthemesettings',
            args: {}
        }]);
    ...
    registerEventListeners() {
        ...
        this.getModal().on(CustomEvents.events.activate, '[data-action="save"]', function() {
            let request = Ajax.call([{
                methodname: 'theme_luuniensuki_savethemesettings',
                args: {
